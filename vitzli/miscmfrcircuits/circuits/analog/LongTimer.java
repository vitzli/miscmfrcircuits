 ...
 * Qs 	- activates every for one tick second of activePeriod
 * Qm 	- one tick every minute
 * Qh 	- one tick every hour
 *   
 * 
 */ 
...
public class LongTimer implements IRedNetLogicCircuit {
	...
	public int[] recalculateOutputValues(long worldTime, int[] inputValues) {
		...
		return new int[] { state ? 15 : 0,
				(currentShift % 20 == 0 && state) ? 15 : 0,
				(currentShift % 1200 == 0 && state) ? 15 : 0,
				(currentShift % 72000 == 0 && state) ? 15 : 0 };
	}
